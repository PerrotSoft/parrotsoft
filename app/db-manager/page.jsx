            ...
            <header style={styles.header}>
                ...
                <div>
                    ...
                    <button
                        ...
                        style={{ ...styles.btnSecondary, marginLeft: '10px', color: '#ff5555', borderColor: '#442222' }}
                        onMouseOver={(e) => { e.target.style.background = 'rgba(255, 68, 68, 0.1)'; e.target.style.borderColor = '#ff4444'; }}
                        onMouseOut={(e) => { e.target.style.background = 'transparent'; e.target.style.borderColor = '#442222'; }}
                    >
                        🗑️ DELETE DATABASE
                    </button>
                </div>
                        ...
                        <div style={{ 
                            ...
                            {Object.keys(currentParsedData).map(key => (
                                <div key={key} style={{
                                    ...
                                    onMouseOver={(e) => e.currentTarget.style.borderColor = '#00ff4155'}
                                        ...
                                        <>
                                            <div style={{ flex: 1, overflow: 'hidden', paddingRight: '15px' }}>
                                                    <div style={{
                                                        ...
                                                        <div style={{ color: '#00ff41', fontSize: '12px', marginBottom: '5px', fontWeight: 'bold', letterSpacing: '0.3px' }}>
                                                            {key}
                                                        </div>
...
const styles = {
    ...
    guiItem: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#111', padding: '15px', borderLeft: '3px solid #00ff41', borderRadius: '6px', transition: 'background 0.15s' },
    guiValue: {
        color: '#9fb0a8',
