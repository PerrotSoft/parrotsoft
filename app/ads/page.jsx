...
export default function AdsPage() {
  ...
  if (loading) return (
    <div style={styles.loadingWrap}>
      ...
      <p style={{ color: 'rgba(255,255,255,0.5)', marginTop: 16, fontSize: 14 }}>Loading ParrotSoft.Ads...</p>
    </div>
  );
    ...
    <div style={styles.root}>
      ...
      <div style={styles.selectWrap}>
        <div style={styles.logo}>
          ...
          <span style={styles.logoText}>ParrotSoft<b>.Ads</b></span>
        </div>
    ...
    <div style={styles.root}>
      ...
      <div style={styles.topBar}>
        ...
        <div style={styles.logo}>
          ...
          <span style={styles.logoTextSm}>ParrotSoft<b>.Ads</b></span>
        </div>
